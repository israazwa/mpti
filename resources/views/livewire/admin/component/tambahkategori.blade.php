<section class="p-6 bg-gray-900 rounded-lg shadow-lg">
    ...
    <form action="{{ route('categories.store') }}" method="POST" class="space-y-4 mb-6">
        @csrf
        <div>
                        ...
                        <div x-show="openEdit"
                            ...
                            <div class="bg-gray-900 rounded-lg shadow-lg w-full max-w-md p-6">
                                ...
                                <form action="{{ route('categories.update', $category->id) }}" method="POST" class="space-y-4">
                                    ...
                                    <div>
                                        <label for="description{{ $category->id }}" class="block text-sm font-medium text-gray-300">Deskripsi</label>
                                        <textarea name="description" id="description{{ $category->id }}"
                                                  class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white focus:ring-indigo-500 focus:border-indigo-500">{{ $category->description }}</textarea>
                                    </div>
