...
@endif
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 items-stretch">
        ...
        <div class="lg:col-span-1 space-y-4 flex flex-col justify-center ">
            ...
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Soluta praesentium quos magni illo. Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit.
            </p>
            <a href="shop.html"
      ...
      <div wire:click="addToCart({{ $product->id }})"
        wire:change="$refresh"
            ...
            <div class="shine-img">
                <img src="{{ asset('produk.png') }}" alt="Nordic Chair" class="mx-auto object-contain">
            </div>
            ...
            <!-- Tombol Add to Cart -->
            <button 
                    class="absolute left-1/2 transform -translate-x-1/2 translate-y-1 block space-y-5">
